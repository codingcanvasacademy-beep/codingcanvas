...
export default function Home() {
  ...
  return (
    <div className="relative overflow-hidden bg-white scroll-smooth">
      ...
      {/* Advantage Section */}
      <section id="advantage" className="py-24 bg-cc-surface-muted relative">
        <div className="container mx-auto px-6 text-center space-y-16">
          <div className="max-w-2xl mx-auto space-y-4">
            <h2 className="text-4xl md:text-5xl font-black tracking-tight text-cc-secondary">The CodingCanvas Advantage</h2>
      ...
      <section id="book" className="py-20 px-6">
        <div className="container mx-auto max-w-5xl rounded-[40px] bg-cc-primary-light p-12 md:p-20 flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="text-left space-y-4">
            ...
            <p className="text-xl font-medium text-gray-600">Your child's professional coding journey starts here.</p>
          </div>
          <button 
            onClick={() => setShowModal(true)}
      ...
      <footer className="py-12 border-t border-gray-100">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-wrap justify-center gap-8 text-gray-400 font-medium text-sm">
            ...
            <Link href="https://wa.me/919899041906" target="_blank" className="hover:text-cc-primary transition-colors">Contact</Link>
          </div>
